...
import io.nekohasekai.ktlib.td.generator.tl.TlAddition.Other
import io.nekohasekai.ktlib.td.generator.tl.TlAddition.SizeRequired
...
fun TlAddition(addition: String): TlAddition = when (addition.toLowerCase()) {
    ...
    """should begin with "https://t.me/joinchat/", "https://telegram.me/joinchat/", or "https://telegram.dog/joinchat/"""" ->
        TlAddition.StartWithRequired(listOf("https://t.me/joinchat/", "https://telegram.me/joinchat/", "https://telegram.dog/joinchat/"))
    "up to 100" ->
        SizeRequired(0, 100)
    "use 65" ->
        SizeRequired(65, 65)
