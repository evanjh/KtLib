...
public interface ITesseract {
     ...
     * @throws TesseractException
     */
    OCRResult createDocumentsWithResults(BufferedImage bi, String filename, String outputbase, List<RenderedFormat> formats, int pageIteratorLevel) throws TesseractException;
     ...
     * @throws TesseractException
     */
    List<OCRResult> createDocumentsWithResults(BufferedImage[] bis, String[] filenames, String[] outputbases, List<RenderedFormat> formats, int pageIteratorLevel) throws TesseractException;
     ...
     * @throws TesseractException
     */
    OCRResult createDocumentsWithResults(String filename, String outputbase, List<RenderedFormat> formats, int pageIteratorLevel) throws TesseractException;
     ...
     * @throws TesseractException
     */
    List<OCRResult> createDocumentsWithResults(String[] filenames, String[] outputbases, List<RenderedFormat> formats, int pageIteratorLevel) throws TesseractException;
