 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetTextEntities) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<TextEntities>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: ParseTextEntities) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<FormattedText>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: ParseMarkdown) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<FormattedText>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetMarkdownText) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<FormattedText>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetFileMimeType) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Text>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetFileExtension) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Text>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: CleanFileName) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Text>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetLanguagePackString) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<LanguagePackStringValue>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetJsonValue) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<JsonValue>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetJsonString) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Text>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetChatFilterDefaultIconName) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Text>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetPushReceiverId) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<PushReceiverId>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: SetLogStream) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Ok>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetLogStream) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<LogStream>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: SetLogVerbosityLevel) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Ok>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetLogVerbosityLevel) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<LogVerbosityLevel>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetLogTags) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<LogTags>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: SetLogTagVerbosityLevel) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Ok>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: GetLogTagVerbosityLevel) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<LogVerbosityLevel>(f)
 ...
 * Can be called synchronously
 */
fun syncRaw(f: AddLogMessage) = io.nekohasekai.ktlib.td.core.extensions.syncRaw<Ok>(f)
