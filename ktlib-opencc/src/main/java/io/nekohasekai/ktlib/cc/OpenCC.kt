...
class CCConverter(target: CCTarget) {
    ...
    fun convert(input: String): String {
        var result = input
        for (trie in tries) {
            result = segLongest(result.toCharArray(), trie)
        }
        return result
    }

    private fun segLongest(charArray: CharArray, trie: AhoCorasickDoubleArrayTrie<String>): String {
